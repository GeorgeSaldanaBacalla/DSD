 ...
 * 
 */
@WebServiceClient(name = "ClienteWS", targetNamespace = "http://service.soappet.com.pe/", wsdlLocation = "http://localhost:8080/ClienteWS/ClienteWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CLIENTEWS_QNAME = new QName("http://service.soappet.com.pe/", "ClienteWS");
    ...
    public ClienteWS getClienteWSPort() {
        return super.getPort(new QName("http://service.soappet.com.pe/", "ClienteWSPort"), ClienteWS.class);
    }
    ...
    public ClienteWS getClienteWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.soappet.com.pe/", "ClienteWSPort"), ClienteWS.class, features);
    }
